    ...
    <div className="layout">
        ...
        <div className="catalogButtons">
          <button
            ...
            style={{
              ...
              padding: '8px',
              borderRadius: '8px',
              background: showSessions ? 'rgba(140,94,145,0.3)' : 'transparent',
            }}
          >
      ...
      <div className="chatSection">
        <div className="chatHeader">
          ...
          <button className="burgerButton" onClick={() => setSidebarOpen(true)}>
            ☰
          </button>
        </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              height: '40px',
              borderRadius: '50%',
              background: !loading && input.trim() ? '#8c5e91' : '#4a4a4a',
              border: 'none',
