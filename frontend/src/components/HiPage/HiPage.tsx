         ...
         <div className="scene" id="hiContainer">
            ...
            <div className="contentWrapper layer bg">
               <p className="text1" id="text">
                  <span id="text1">Добро</span>{' '}
                  <span id="text2">пожаловать!</span>
               </p>
         ...
         <div className="scene" id="mainContainer">
            ...
            <div className="mainContainerPanel layer mid">
               ...
               <p className="containerPanelDescription" id="panelDescription">
                  Это — Career Intelligence Platform! Твой персональный
                  карьерный конструктор. Создай идеальное резюме, получи
                  предложения от компаний и узнай, какие навыки прокачать для
                  роста зарплаты. Регистрация займёт минуту — начни выстраивать
                  свою карьеру с умом!
               </p>
            </div>
         </div>
